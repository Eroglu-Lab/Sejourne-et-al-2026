...
bigwigCompare -b1 "$bwDir"/01_zbtb20_wt_chip_merged.normalized.normalized.bw \
        -b2 "$bwDir"/02_zbtb20_wt_ctrl_merged.normalized.normalized.bw \
        -o "$bwDir"/01_zbtb20_wt_merged.difference.bw \
	--operation subtract
wait

bigwigCompare -b1 "$bwDir"/03_zbtb20_ko_chip_merged.normalized.normalized.bw \
        -b2 "$bwDir"/04_zbtb20_ko_ctrl_merged.normalized.normalized.bw \
        -o "$bwDir"/02_zbtb20_ko_merged.difference.bw \
	--operation subtract
